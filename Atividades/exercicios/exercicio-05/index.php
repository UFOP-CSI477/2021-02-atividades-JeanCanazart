            ...
            <div>
                ...
                <div>
                    ...
                    <label for="feminino" class="form-check-label" class="form-check-label">Feminino</label>
                        ...
                        <label for="naobinario" class="form-check-label">Não binario</label>
                    </div><div  class="form-check"  >
                    
                        <input type="radio" name="genero" id="naoinf" class="form-check-input" value="nr" checked >
                        <label for="naoinf" class="form-check-label">Prefiro não Informar</label><br>
                    </div> 
                </div>
                    ...
                    <div class="form-check" >
                        ...
                        <label for="naoinformar"  class="form-check-label">Prefiro não Informar</label><br>
                    </div></div>
                    <div class="input-group">
